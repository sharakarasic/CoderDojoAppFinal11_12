...
//  CoderDojo1
//
//  Created by Shara Karasic on 7/2/12.
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self.title = NSLocalizedString(@"Code Resources", @"Code Resources");
        self.tabBarItem.image = [UIImage imageNamed:@"resources"];
...
- (void)viewDidLoad
{
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.coderdojola.com/coderdojo-la-coding-resources/"]]];
...
{
    [self updateBackButton];
    [self.webView stringByEvaluatingJavaScriptFromString:@"window.scrollTo(0.0, 350.0)"];
